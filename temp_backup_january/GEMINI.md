...
> **SYSTEM INSTRUCTION:** ALWAYS read this file at the start of a session. It contains the absolute truth of the project.
...
1.  **The "Trinity" Rule:** Every time we complete a task, you must provide updates for **THREE** files immediately:
...
3.  **Validation:** Before finishing a response, ask yourself: *"Did I update the Roadmap to reflect the work we just did?"*