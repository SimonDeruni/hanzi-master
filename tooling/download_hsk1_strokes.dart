...
Future<void> main() async {
  ...
  print('Downloading REAL Hanzi Writer stroke and MEDIAN data for ${uniqueChars.length} HSK1 characters...\n');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['strokes'] is List && (data['strokes'] as List).isNotEmpty) {
          // Store both strokes (outlines) and medians (centerlines)
          strokeData[char] = {
  ...
  print('\n✅ Saved ${strokeData.length} characters with centerline data to assets/data/hsk1_strokes.json');
}
